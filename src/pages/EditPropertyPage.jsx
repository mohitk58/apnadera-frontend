...
import { ArrowLeft, Upload, MapPin, Home, DollarSign, Bed, Bath, Square, Loader2 } from 'lucide-react'
...
const EditPropertyPage = () => {
    ...
    if (property) {
      reset({
        ...
        details: {
          ...
          sqft: property.details?.squareFeet || 0,
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await updatePropertyMutation.mutateAsync({ id, data: formData })
  ...
  if (property.owner?._id !== user?._id && user?.role !== 'admin') {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <p className="text-red-600 mb-4">You don't have permission to edit this property</p>
          <button 
            onClick={() => navigate(-1)} 
            className="btn-outline"
          >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-2 text-lg">Update your property information</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              <div className="flex items-center space-x-3 mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Update property location</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="md:col-span-2">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              <div className="flex items-center space-x-3 mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Update specifications and features</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              <div className="flex items-center space-x-3 mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Update photos of your property</p>
                </div>
              </div>
              <div className="space-y-6">
                ...
                {property.images && property.images.length > 0 && (
                  <div>
                    <h4 className="text-lg font-medium text-gray-900 mb-4">Current Images</h4>
                      ...
                      {property.images.map((image, index) => (
                        <div key={index} className="relative group">
                          ...
                          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/50 to-transparent p-3 rounded-b-xl">
                            <p className="text-white text-xs font-medium">Current Image {index + 1}</p>
                          </div>
                        </div>
                      ))}
                    </div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-2xl p-8 text-center hover:border-blue-400 transition-colors duration-200">
                  ...
                  <p className="text-gray-600 mb-2 text-lg font-medium">Add new images</p>
                ...
                {images.length > 0 && (
                  <div>
                    <h4 className="text-lg font-medium text-gray-900 mb-4">New Images</h4>
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                      {images.map((image, index) => (
                        <div key={index} className="relative group">
                          ...
                          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/50 to-transparent p-3 rounded-b-xl">
                            <p className="text-white text-xs font-medium">New Image {index + 1}</p>
                          </div>
                        </div>
                      ))}
                    </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              <div className="flex items-center space-x-3 mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Update property features</p>
                </div>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 sm:space-x-4">
                <div className="text-center sm:text-left">
                  <h3 className="text-lg font-semibold text-gray-900">Ready to update your property?</h3>
                  <p className="text-gray-500 text-sm mt-1">Review your changes and submit when ready</p>
                </div>
